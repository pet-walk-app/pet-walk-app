package com.kotkipieski.backend.authentication.handlers;

import com.google.gson.Gson;
import com.kotkipieski.backend.authentication.exceptions.IExceptionWithPublicMessage;
...
public class BadRequestHandler implements AuthenticationEntryPoint, AccessDeniedHandler {
  ...
  private void sendResponse(HttpServletResponse response, String errorMessage, int statusCode)
      throws IOException
  {
