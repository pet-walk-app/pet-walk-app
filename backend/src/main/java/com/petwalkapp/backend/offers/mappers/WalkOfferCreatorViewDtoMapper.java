...
@Mapper(uses = {PetOwnerResponseDtoMapper.class, PetResponseDtoMapper.class,
    UserCaregiverProfileDtoMapper.class, WalkOfferApplicationDtoMapper.class})
public interface WalkOfferCreatorViewDtoMapper
{
  ...
  @Mapping(target = "longitude", expression = "java(walkOffer.getLocation().getX())")
  @Mapping(target = "latitude", expression = "java(walkOffer.getLocation().getY())")
